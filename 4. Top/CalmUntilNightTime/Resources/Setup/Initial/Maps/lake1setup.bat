...
SET /a %MAP%DROWNRESPAWNYCOORD = 7
GOTO :EOF
...
SET /a %MAP%EXIT%COUNT%NEWXCOORD = 9
...
SET /a %MAP%CHEST%COUNT%SPECIALITEM2NUM = 3
...
SET /a %MAP%CHEST%COUNT%WEAPON1 = %LONGBOWID%
...
SET /a %MAP%CHEST%COUNT%SPECIALITEM1 = %EXTRAOXYGENSTONEID%
