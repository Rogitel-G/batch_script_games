...
CALL :MPGILDISPLAY
ECHO.
ECHO %PRIESTNAME%: Choose an animation for your spell. It's currently %PLAYERSPELLANIMATIONDISPLAY%
ECHO.
...
IF "%ANIMATIONCHOICE%" EQU "" (
	GOTO :ANIMATION
) ELSE IF "%ANIMATIONCHOICE%" EQU "0" (
	GOTO :EOF
)
IF %ANIMATIONCHOICE% LSS 0 (
	GOTO :ANIMATION
...
IF %ANIMATIONCHOICE% EQU 1 (
	...
	SET PLAYERSPELLANIMATION2=STATUSSPELL
...
CLS
ECHO.
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-1!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-1!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-2!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-2!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-3!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-3!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-4!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-4!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-5!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-5!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-6!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-6!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-7!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-7!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-8!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-8!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-9!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-9!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-10!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-10!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-11!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-11!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-12!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-12!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-13!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-13!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-14!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-14!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-15!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-15!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-16!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-16!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-17!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-17!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-18!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-18!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-19!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-19!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-20!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-20!
ECHO. !PLAYER%PLAYERSPELLANIMATION2%PLAYER%COUNT%-21!!PLAYER%PLAYERSPELLANIMATION2%MID%COUNT%-21!
ECHO.
TIMEOUT /T 0 > nul
TIMEOUT /T 0 > nul
TIMEOUT /T 0 > nul
IF %COUNT% LSS 3 (
	GOTO :ANIMATIONDISPLAY
)
TIMEOUT /T 0 > nul
TIMEOUT /T 0 > nul
GOTO :EOF
...
CALL :MPGILDISPLAY
ECHO.
ECHO %PRIESTNAME%: Choose a spell category for your spell's sound effect. The sound's currently %SOUNDEFFECTNAME%.
ECHO.
ECHO. 1 - Offensive
ECHO. 2 - Status
ECHO. 3 - Restorative
...
CLS
ECHO.
ECHO %PRIESTNAME%: Choose a spell for your sound effect. It's currently %SOUNDEFFECTNAME%.
ECHO.
SET /a COUNT = 0
:SOUNDEFFECTLOOP
SET /a COUNT = %COUNT% + 1
ECHO. %COUNT% - !%TYPE%%COUNT%SPELL!
IF %COUNT% LSS !%TYPE%SPELLTOT! (
	GOTO :SOUNDEFFECTLOOP
)
ECHO. 0 - Done
ECHO.
SET /P SOUNDEFFECTCHOICE=
IF "%SOUNDEFFECTCHOICE%" EQU "" (
	GOTO :SPELLSOUNDEFFECT
) ELSE IF "%SOUNDEFFECTCHOICE%" EQU "0" (
	GOTO :EOF
)
IF %SOUNDEFFECTCHOICE% LSS 0 (
	GOTO :SPELLSOUNDEFFECT
) ELSE IF %SOUNDEFFECTCHOICE% GTR !%TYPE%SPELLTOT! (
	GOTO :SPELLSOUNDEFFECT
)
SET SOUNDEFFECTNAME=!%TYPE%%SOUNDEFFECTCHOICE%SPELL!
SET TEMPPATH=%MUSICPATH%\Battle\Spells
IF EXIST "%TEMPPATH%\!%TYPE%%SOUNDEFFECTCHOICE%SPELL!.mp3" (
	SET PLAYERSPELLSOUNDEFFECT=!%TYPE%%SOUNDEFFECTCHOICE%SPELL!
) ELSE IF EXIST "%TEMPPATH%\!%TYPE%%SOUNDEFFECTCHOICE%EFFECT1ELEMENT!.mp3" (
	SET PLAYERSPELLSOUNDEFFECT=!%TYPE%%SOUNDEFFECTCHOICE%EFFECT1ELEMENT!
)
SET FILE=%PLAYERSPELLSOUNDEFFECT%.mp3
...
ECHO. 3 - Display Animation and Sound
ECHO. 0 - Back
ECHO.
:CONFIRMATIONCHOICE
...
IF "%CONFIRMATIONCHOICE%" EQU "1" (
	...
	ECHO.
	CALL :WAITFORTHREE
) ELSE IF "%CONFIRMATIONCHOICE%" EQU "3" (
	CALL :DISPLAYSPELL
	GOTO :CONFIRMATION
...
ECHO SET PLAYERSPELLSOUNDEFFECT=%PLAYERSPELLSOUNDEFFECT%>>"%CUSTOMSPELLRESOURCEPATH%\Temp\customspell%SPELLSLOTNUM%.bat"
SET /a EFFECTNUM = 0
:EFFECTSLOOPSTART
...
SET PLAYERSPELLANIMATION2=FIRESPELL
SET PLAYERSPELLANIMATIONDISPLAY=Fire Spell Animation
SET PLAYERSPELLSOUNDEFFECT=Fire
SET SOUNDEFFECTNAME=Fire
GOTO :EOF
